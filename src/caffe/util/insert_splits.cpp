...
void InsertSplits(const NetParameter &param, NetParameter *param_split)
{
  ...
  for (int i = 0; i < param.layer_size(); ++i)
  {
    ...
    fwd_type = layer_param.has_forward_type() ? layer_param.forward_type() : param.default_forward_type();
    bwd_type = layer_param.has_backward_type() ? layer_param.backward_type() : param.default_backward_type();
