...
void InnerProductLayer<Ftype, Btype>::LayerSetUp(const vector<Blob *> &bottom, const vector<Blob *> &top)
{
...
template <typename Ftype, typename Btype>
void InnerProductLayer<Ftype, Btype>::Reshape(const vector<Blob *> &bottom, const vector<Blob *> &top)
{
