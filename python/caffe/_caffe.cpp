...
BOOST_PYTHON_MODULE(_caffe)
{
  ...
  bp::class_<Net, shared_ptr<Net>, boost::noncopyable>("Net",
      ...
      .def("__init__", bp::make_constructor(&Net_Init,
                                            bp::default_call_policies(), (bp::arg("network_file"), "phase", bp::arg("level") = 0, bp::arg("stages") = bp::object(), bp::arg("weights") = bp::object())))
      // Legacy constructor
  ...
  bp::class_<Solver, shared_ptr<Solver>, boost::noncopyable>(
      ...
      .def("solve", static_cast<bool (Solver::*)(const char *)>(&Solver::Solve), SolveOverloads())
