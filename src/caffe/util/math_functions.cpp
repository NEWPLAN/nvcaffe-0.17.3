...
template void caffe_rng_uniform<float>(int n, float a, float b, Blob *blob);
template void caffe_rng_uniform<double>(int n, double a, double b, Blob *blob);
template <>
...
template void caffe_rng_uniform<float>(int n, float a, float b, float *r);
template void caffe_rng_uniform<double>(int n, double a, double b, double *r);
...
template void caffe_rng_gaussian<float>(int n, float mu, float sigma, Blob *blob);
template void caffe_rng_gaussian<double>(int n, double mu, double sigma, Blob *blob);
template <>
...
template void caffe_rng_gaussian<float>(int n, float mu, float sigma, float *r);
template void caffe_rng_gaussian<double>(int n, double mu, double sigma, double *r);
template <>
...
template float16 caffe_cpu_dot<float16>(const int n, const float16 *x, const float16 *y);
...
template float caffe_cpu_amax<float>(const int n, const float *x);
template double caffe_cpu_amax<double>(const int n, const double *x);
template float16 caffe_cpu_amax<float16>(const int n, const float16 *x);
