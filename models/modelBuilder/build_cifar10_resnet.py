...
def addRes_small(model, name, bottom, num_output, group, j, fix_dim, dilation=False):
    ...
    block, top = addActivation(
        model=block, name="{}relu".format(name), bottom=top)
